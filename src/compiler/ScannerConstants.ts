export const ScannerConstants = {
    ...
    TOKEN_STATE: [- 2, 0, -1, -1, 0, 37, -1, 24, 25, 34, 32, 38, 33, 35, 3, 39, 28, 40, 30, -2, 2, 27, 5, 41, 42, 36, -1, 29, 26, 31, -2, 2, -1, 2, 4, -2, 0],

    SPECIAL_CASES_INDEXES:
    ...
    SPECIAL_CASES_VALUES:
        [9, 13, 14, 19, 20, 7, 15, 12, 16, 22, 6, 11, 10, 23, 17, 8, 21, 18],
